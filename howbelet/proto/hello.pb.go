...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x9e, 0x02, 0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	0x57, 0x6f, 0x72, 0x6c, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a, 0x08,
	...
	0x22, 0x00, 0x12, 0x42, 0x0a, 0x14, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x43, 0x6c,
	...
	0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x12, 0x42, 0x0a, 0x14, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c,
	...
	0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x30, 0x01, 0x12, 0x4b, 0x0a, 0x1b, 0x53, 0x61,
	0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x42, 0x69, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x61, 0x6c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x13, 0x2e, 0x68, 0x65, 0x6c, 0x6c,
	...
	0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x10, 0x5a, 0x0e, 0x68, 0x6f, 0x77, 0x62, 0x65,
...
var file_proto_hello_proto_depIdxs = []int32{
	...
	0, // 1: hello.HelloWorldService.SayHelloClientStream:input_type -> hello.HelloRequest
	0, // 2: hello.HelloWorldService.SayHelloServerStream:input_type -> hello.HelloRequest
	0, // 3: hello.HelloWorldService.SayHelloBidirectionalStream:input_type -> hello.HelloRequest
	1, // 4: hello.HelloWorldService.SayHello:output_type -> hello.HelloReply
	1, // 5: hello.HelloWorldService.SayHelloClientStream:output_type -> hello.HelloReply
	1, // 6: hello.HelloWorldService.SayHelloServerStream:output_type -> hello.HelloReply
	1, // 7: hello.HelloWorldService.SayHelloBidirectionalStream:output_type -> hello.HelloReply
